<div class="card events-card">
    <header class="card-header">
        <div class="card-header-title"><?= ($AdminApi_token_management_title) ?><p class="tooltip-info tooltip" title="<?= ($AdminApi_token_management_title_tooltip) ?>"><?php echo $this->render('images/icons/information.svg',NULL,get_defined_vars(),0); ?></p>
        </div>
    </header>
