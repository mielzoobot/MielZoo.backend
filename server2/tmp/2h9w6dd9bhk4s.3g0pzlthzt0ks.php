<div class="card events-card" data-item-id="profile-form">
    <form method="POST" action="<?= ($BASE) ?>/settings">
        ...
        <header class="card-header">
            <div class="card-header-title"><?= ($AdminSettings_changeEmail_form_title) ?><p class="tooltip-info tooltip" title="<?= ($AdminSettings_changeEmail_form_title_tooltip) ?>"><?php echo $this->render('images/icons/information.svg',NULL,get_defined_vars(),0); ?></p>
            </div>
        </header>

        <div class="card-content">
            <div class="content">
                <?php if ($waitingForConfirmation): ?>
