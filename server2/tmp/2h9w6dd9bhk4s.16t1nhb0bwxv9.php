<span class="kwd">import</span> <span class="mod">requests</span>
<span class="kwd">import</span> <span class="mod">json</span>
<span class="var">url</span> <span class="opr">=</span> <span class="pct">'</span><span class="str"><?= ($apiUrl) ?></span><span class="pct">'</span>     <span class="cmt"># sensor URL</span>
...
<span class="var">data</span> <span class="opr">=</span> <span class="brc">{</span>
    ...
    <span class="brc">]</span>
<span class="brc">}</span>
<span class="var">data</span> <span class="opr">=</span> <span class="brc">{</span><span class="var">k</span><span class="opr">:</span> <span class="var">v</span> <span class="kwd">for</span> <span class="var">k</span><span class="sep">,</span> <span class="var">v</span> <span class="kwd">in</span> <span class="var">data</span><span class="acc">.</span><span class="sfn">items</span><span class="brc">(</span><span class="brc">)</span> <span class="kwd">if</span> <span class="var">v</span> <span class="kwd">is</span> <span class="kwd">not</span> <span class="con">None</span><span class="brc">}</span>
<span class="kwd">if</span> <span class="pct">'</span><span class="str">payload</span><span class="pct">'</span> <span class="kwd">in</span> <span class="var">data</span><span class="opr">:</span>
    <span class="var">data</span><span class="brc">[</span><span class="pct">'</span><span class="str">payload</span><span class="pct">'</span><span class="brc">]</span> <span class="opr">=</span> <span class="var">json</span><span class="acc">.</span><span class="sfn">dumps</span><span class="brc">(</span><span class="var">data</span><span class="brc">[</span><span class="pct">'</span><span class="str">payload</span><span class="pct">'</span><span class="brc">]</span><span class="brc">)</span>
<span class="kwd">if</span> <span class="pct">'</span><span class="str">fieldHistory</span><span class="pct">'</span> <span class="kwd">in</span> <span class="var">data</span><span class="opr">:</span>
    <span class="var">data</span><span class="brc">[</span><span class="pct">'</span><span class="str">fieldHistory</span><span class="pct">'</span><span class="brc">]</span> <span class="opr">=</span> <span class="var">json</span><span class="acc">.</span><span class="sfn">dumps</span><span class="brc">(</span><span class="var">data</span><span class="brc">[</span><span class="pct">'</span><span class="str">fieldHistory</span><span class="pct">'</span><span class="brc">]</span><span class="brc">)</span>
<span class="var">response</span> <span class="opr">=</span> <span class="var">requests</span><span class="acc">.</span><span class="sfn">post</span><span class="brc">(</span><span class="var">url</span><span class="sep">,</span> <span class="var">data</span><span class="opr">=</span><span class="var">data</span><span class="sep">,</span> <span class="var">headers</span><span class="opr">=</span><span class="var">headers</span><span class="brc">)</span>
