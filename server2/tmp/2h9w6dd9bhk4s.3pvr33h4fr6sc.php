<div class="card events-card" data-item-id="profile-form">
    <form method="POST" action="<?= ($BASE) ?><?= (Base::instance()->alias('settings')) ?>">
        ...
        <header class="card-header">
            <div class="card-header-title"><?= ($AdminRetentionPolicy_form_title) ?><p class="tooltip-info tooltip" title="<?= ($AdminRetentionPolicy_form_title_tooltip) ?>"><?php echo $this->render('images/icons/information.svg',NULL,get_defined_vars(),0); ?></p>
            </div>
        </header>
