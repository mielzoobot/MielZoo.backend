...
<head>
    ...
    <?php if (isset($LOAD_JVECTORMAP) && $LOAD_JVECTORMAP): ?>
        ...
        <script type="text/javascript" src="<?= ($BASE) ?>/ui/js/vendor/jvectormap-2.0.5/jquery-jvectormap-2.0.5.min.js"></script>
        
        <script src="<?= ($BASE) ?>/ui/js/vendor/jvectormap-2.0.5/jquery-jvectormap-world-mill-en.js"></script>
    <?php endif; ?>
