    ...
    <body id="page-top" class="index">
        ...
        <header class="masthead text-bg-primary p-3 text-white text-center ">
            <div class="container d-flex align-items-center flex-column">
                ...
                <span class="skills">
                    <p class="text-center typewrite" data-period="2000" data-type='[ "Créez", "Simplifiez-vous la vie", "Travaillez sans y penser", "", "", "", "" ]'>
        ...
        <footer class="footer text-center text-bg-info p-3">
            <div class="container">
                <div class="row">
                    <!-- Social link -->
                    <div class="">
                        <h4 class="text-uppercase mb-4">Build with ❤️ in guadeloupe but also</h4>
