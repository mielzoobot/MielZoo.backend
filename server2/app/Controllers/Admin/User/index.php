 ...
 <script>
    ...
    <body id="page-top" class="index">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            ...
            <div class="container">
                 <a class="navbar-brand" href="http://mielzoo.cloud:3000/">

            <img src="https://dashboard.mielzoostore.cloud/ressources/img/Mielzoo2.png"
                 height="60"
                 alt="MielZoo.cloud"
                 loading="lazy" />

        </a>
             <span class="navbar-brand ">MielZoo</span>  
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">S'identifier</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#timeline">Documentation</a></li>
                       <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Support</a></li>
                     </ul>
        ...
        <!-- Masthead-->
        <header class="masthead text-bg-primary p-3 text-white text-center ">
            <div class="container d-flex align-items-center flex-column">
                ...
                <span class="skills">
                    <p class="text-center typewrite" data-period="2000" data-type='[ "CrÃ©ez", "Simplifiez-vous la vie", "Travaillez sans y penser", "", "", "", "" ]'>
  ...
  ">
            <div class="container bg-image">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Store</h2>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fa-solid fa-store"></i></div>
                    <div class="divider-custom-line"></div>
                </div>
                <div class="divider-custom">
                    ...
                    <button class="btn filter-button" data-filter="tools2">ComptabilitÃ©</button>
                    ...
                    <button class="btn filter-button" data-filter="tools5">RÃ©seaux Sociaux</button>
                </div>
                ...
                <div id="portfolio-gallery" class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter games highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalNarivia">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/giphy.gif" alt="Narivia" />
                        </div>
                    </div>
                    <!-- 2,1 -->
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter mods highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalMoreCulturalNames">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white">ModÃ¨le Flux de TrÃ©sorerie</div>
                            </div>
                            <img class="img-fluid" src="assets/img/portfolio/more-cultural-names.png" alt=" Cultural Names" />
                        </div>
                    </div>
                    <!-- 3,1 -->
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter tools highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalGeForceNowElectron">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/geforcenow-electron.png" alt="GeForce NOW for Linux" />
                        </div>
                    </div>
                    <!-- 1,2 -->
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter tools highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalIptvPlaylistAggregator">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/iptv-playlist-aggregator.png" alt="IPTV Playlist Aggregator" />
                        </div>
                    </div>
                    <!-- 2,2 -->
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter tools highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalUniversalNameGenerator">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/universal-name-generator.png" alt="Universal Name Generator" />
                        </div>
                    </div>
                    <!-- 3,2 -->
                    <div class="col-md-6 col-lg-4 mb-5 wow animate__animated animate__bounceIn filter tools highlights">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalDuolingoDesktop">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/duolingo-desktop.png" alt="Duolingo Desktop" />
                        </div>
                    </div>
                    <!-- 1,3 -->
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 wow animate__animated animate__bounceIn filter tools">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalBitwardenVaultManager">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/bitwarden-vault-manager.png" alt="Bitwarden Vault Manager" />
                        </div>
                    </div>
                    <!-- 2,3 -->
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 wow animate__animated animate__bounceIn filter games">
                        ...
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModalMemoryBlocks">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/memoryblocks.png" alt="Memory Blocks" />
                        </div>
                    </div>
                    <!-- 2,4 -->
        ...
        <!-- Footer-->
        <footer class="footer text-center text-bg-info p-3">
            <div class="container">
                <div class="row">
                    <!-- Social link -->
                    <div class="">
                        <h4 class="text-uppercase mb-4">Build with â¤ï¸ in guadeloupe but also</h4>
                        <a class="btn btn-outline-light btn-social mx-1 btn-github" href=""><i class="fa-brands fa-bootstrap"></i></a>
                        <a class="btn btn-outline-light btn-social mx-1 btn-github" href=""><i class="fab fa-docker"></i></a>
                        <a class="btn btn-outline-light btn-social mx-1 btn-github" href=""><i class="fab fa-gitlab"></i></a>
                        <a class="btn btn-outline-light btn-social mx-1 btn-github" href=""><i class="fa-brands fa-jenkins"></i></a>
                    </div>
                    <!-- Development links -->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="portfolioModalBackgammonLabel">Backgammon by HoraÈ›iu</h2>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                    ...
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/backgammon.png" alt="" />
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/bitwarden-vault-manager.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/duolingo-desktop.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/geforcenow-electron.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/iptv-playlist-aggregator.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/memoryblocks.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/minesweeper.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/narivia.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    ...
                                    <br>
                                    <p>The player must lead their people to the ultimate victory, by raising the countryâ€™s economy and expanding its territories using military force. The enemies will share the same dream and will not give up their territories easily, challenging tactical scenarios that the player must overcome.</p>
                                    <br>
                                    <p>The player has at its disposal an array of units and buildings that can be created, each being specific to the factionâ€™s culture.</p>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 text-center">
                                            <div class="feature-box">
                                                <i class="fas fa-4x fa-chess-rook"></i>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/sokogrump.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="assets/img/portfolio/universal-name-generator.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
